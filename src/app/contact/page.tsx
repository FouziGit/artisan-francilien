                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href="https://wa.me/33765822626" target="_blank" rel="noopener noreferrer" className="text-sm text-[#6B6B6B] hover:text-[#25D366] transition-colors">07.65.82.26.26</a>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-0.5 text-[#3B6EA6]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
