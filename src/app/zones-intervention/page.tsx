              ...
              >
                <div className={`grid md:grid-cols-5 ${idx % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
                  ...
                  <div className={`p-8 md:col-span-3 ${idx % 2 === 1 ? "md:order-1" : ""}`}>
                    ...
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-[#B8860B] mb-3">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {SERVICES.map((s) => (
                        <Link
                          key={s.slug}
                          href={s.href}
                          className="inline-flex items-center gap-2 rounded-lg border border-[#E8E0D0] bg-white px-3 py-2 text-xs font-medium text-[#2D2D2D] hover:border-[#B8860B]/40 hover:text-[#B8860B] transition-colors"
                        >
                          <span>{s.icon}</span>
                          {s.title}
                        </Link>
